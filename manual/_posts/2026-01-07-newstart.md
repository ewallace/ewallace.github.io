...
Most _external_ communication happens on email. If you're asking a lab business-related question or wet lab space, if in doubt cc Edward, who prefers to be kept informed.
...
Get your student/staff card as soon as possible, from [card services](https://www.ed.ac.uk/information-services/help-consultancy/card). To get access to the Waddington building, email institute administrator Julie Davidson and cc Edward. If allowed after the opening hours use card then enter your card PIN (see [card help](https://www.ed.ac.uk/information-services/help-consultancy/card)) to access building.

## Lack of access

Remote working due to illness or any other more specific reason, can be hard.
...
We are affiliated with the [Centre for Engineering Biology](https://biology.ed.ac.uk/centre-engineering-biology), formerly known as **SynthSys**. This is a vibrant research community of people who, like us, are interested in interdisciplinary studies of biological systems.
...
* Weekly lab meetings, currently Wednesdays 13:30 - 15:00.
...
* Many Mondays, ICMB seminar at noon (Attendance usually valuable)
...
* Fungal minisymposium - approximately quarterly meeting of fungal researchers in Edinburgh.
...
Your University ID card is needed to print.
...
Every so often, IT changes their mind about how printing services work.


## School of Biological Sciences info

Various info and links on [SBS homepage](https://biology.ed.ac.uk).
...
https://www.ed.ac.uk/staff/services-support/hr-and-finance/people-and-money-system/people-and-money-user-guides

The Kings' Buildings stores team also have helpful information, kbstores@ed.ac.uk.
...
Currently (January 2026) most staff and students have access, it seems to work.
PhD students should email Andrea Shulz in SBS finance office (and cc Edward if that helps).


### Grant budgets

Currently it's possible to check grant budgets via People & Money. (Details need to be updated).
...
UPDATE 2026 - we now use protocols.io much less as there wasn't wide adoption. It can still be a useful place.
...
NOTE 2026 - this needs updating as rather out of date. Help appreciated.
