...
Most _internal_ lab communication happens on slack where possible.
...
Get your student/staff card as soon as possible, from [card services](https://www.ed.ac.uk/information-services/help-consultancy/card). To get access to the Waddington building, email synthsys administrator Julie Fyffe and cc Edward. If allowed after the opening hours use card then enter your card PIN (see https://www.myed.ed.ac.uk/) to access building. This is all subject to special risk assessments and agreements during Covid.
...
* Alternate Wednesdays, ICMB internal seminars (Attendance encouraged) - this is the best way to learn abotu what other people in the institute are doing
...
There are [many interesting seminars in the school of biological sciences, listed on the website](https://www.ed.ac.uk/biology/news-events/events-and-seminars). SynthSys and ICMB seminars are also listed there.
...
Register for a VPN account using: https://www.ed.ac.uk/information-services/computing/desktop-personal/vpn 
...
To get an account, email [data.support@ed.ad.uk](mailto:data.support@ed.ad.uk) and cc Edward, subject: Add user to Wallace lab Rspace, and include your UUN.
...
We use [protocols.io](https://www.protocols.io/) to write, share, edit protocols. It's a great site! Create an account with your @ed.ac.uk email address. Ask to join the [Wallace lab for Fungal RNA group](https://www.protocols.io/file-manager/E68E74620CE1490A9C37DF9BEE96E98A).
...
protocols.io, like RSpace, is a service that we pay for access to. Don't be embarrassed to ask for help, we are paying for that service.
...
If you need to use plate readers: create an account on  http://synthsys.bio.ed.ac.uk/biosched/index.php then ask someone to email (who?) for you to have the access. You can now book the machines. This page is accessible only with eduroam Wifi. You may have to join the weekly meeting if you are going to use it regularly. 
...
We take safety seriously. If anyone were to be careless, there would be a number of ways to damage yourself or other people involving chemicals, explosions, and opportunistic pathogens. Learn to take care. We *must* follow the [health and safety guidance from the  School as described in SBS wiki](https://www.wiki.ed.ac.uk/display/SBSIntranet/Health+and+Safety). We also need to learn about the risks, how big they are, how to avoid them, and generally how to take care.
...
If you notice anyone else doing anything dangerous or risky, talk to them and talk to Edward.
