...
Most _internal_ lab communication happens on slack first. When it's helpful to talk to someone "in person" or by video call - ask to set it up. In person is hard right now due to COVID-19, but video calls are doable.
